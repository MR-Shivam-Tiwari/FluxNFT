        ...
        >
          <div className="relative p-4 w-full max-w-2xl ">
            <div className="relative bg-white rounded-lg shadow ">
              ...
              <div class="w-full max-w-2xl mx-auto py-5 px-4 sm:px-6 lg:px-8 overflow-y-auto   sm:max-h-screen">
                <div class="space-y-6">
              ...
              <div className="w-full  px-4">
                ...
                <div  onClick={() => {
                  ...
                  <button
                    ...
                    class="flex items-center lg:hidden  text-2xl  gap-2   bg-orange-500 border-orange-500 shadow font-bold    justify-center whitespace-nowrap rounded-[4px] h-10 md:rounded-md lg:rounded-md  ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 border border-input bg-background hover:bg-accent hover:text-accent-foreground  lg:h-10 md:h-10  px-2 md:px-4 lg:px-4  py-3 text-md lg:text-lg md:text-lg "
                  >
                    Search
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
