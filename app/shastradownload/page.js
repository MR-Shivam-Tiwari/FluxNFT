            ...
            <div class="flex min-h-screen flex-col items-center justify-center bg-background px-4 py-12 sm:px-6 bg-orange-100 lg:px-8">
                <div class="mx-auto max-w-md text-center">
                    <div class="animate-fade-in">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="106" height="106" fill="currentColor" class="bi bi-cloud-arrow-down" viewBox="0 0 16 16">
                        ...
                        <h1 class="mt-5 lg:text-3xl text-center font-bold tracking-tight text-foreground text-nowrap text-xl">Download PDF is  Not Available</h1>
                        </div>
                        <div className='flex justify-center'>
