...
function Anugita() {
  ...
  const formatDescription = (Text) => {
    ...
    formattedDescription = formattedDescription.replace(
      /'([^']*)'/g,
      '<p style="color: #ea580c; font-size:20px; margin-bottom:10px;margin-top:30px;"><br />$1</p> <span style="color: #ea580c;font-weight: bold;">Translation</span> '
    );
    formattedDescription = formattedDescription.replace(
      /`([^`]*)`/g,
      '<div style="text-align: center; font-weight: bold; margin-top:30px; font-size:30px; line-height: 1.5;">$1</div>'
    );
  ...
  return (
    <div
      className="mt-6"
      style={{ backgroundImage: 'url("/bgg.png")', backgroundSize: "cover", backgroundPosition: "center" }}
    >
      <div className="min-h-screen flex flex-col items-center">
            ...
            {chapters.map((chapter, index) => (
              <button
                ...
                className={`inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 border border-input bg-background hover:bg-accent hover:text-accent-foreground h-8 px-3 py-2 ${
                  selectedChapter === parseInt(chapter) ? "bg-orange-600" : "bg-orange-200"
                }`}
              >
                {chapter}
              </button>
        ...
        <div className="bg-orange-100 w-full p-2 lg:px-20 flex justify-between fixed bottom-0 left-0">
          ...
          <button
            ...
            className={`inline-flex items-center justify-center w-[140px] whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 hover:bg-primary/90 h-10 px-4 py-2 ${
