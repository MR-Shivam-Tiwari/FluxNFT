        ...
        <div className='bg-gray-200 h-full mt-5'>
            <div className=" ">
                <div className="flex flex-col md:flex-row items-start justify-center gap-8 p-6 md:p-12 bg-gray-200 ">
                    ...
                    <div className="flex-1 space-y-4 text-start md:text-left">
                        <div className="flex items-center mb-10 justify-between ">
                            <h1 className="text-3xl  font-bold">Anu Gita English</h1>
              ...
              Purchase
                                    ...
                                    <Link href='/scriptures/geeta/3/anugeetaenglish' shallow>
                                        <button
              ...
              Purchase
                                ...
                                <div className="w-full">
                                    <Link className="w-full" href='/scriptures/geeta/3/anugeetaenglish' shallow>
                                        <button
