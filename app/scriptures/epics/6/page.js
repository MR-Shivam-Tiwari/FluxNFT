        ...
        <div className='bg-gray-200 h-full'>
            <div className=" ">
                <div className="flex flex-col md:flex-row items-start justify-center gap-8 p-6 md:p-12 bg-gray-200 ">
                    ...
                    <div className="flex-1 space-y-4 text-start md:text-left">
                        <div className="flex items-center mb-10 justify-between ">
                            <h1 className="text-3xl  font-bold">Mahabharata Bori-CE</h1>
              ...
              Purchase
                                    ...
                                    <Link href='/scriptures/epics/6/mahabharat-bori-ce' shallow>
                                        <button
              ...
              Purchase
                                ...
                                <div className="w-full">
                                    <Link className="w-full" href='/scriptures/epics/6/mahabharat-bori-ce' shallow>
                                        <button
