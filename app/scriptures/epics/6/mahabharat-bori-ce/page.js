...
function MahabharatBoriCe() {
  ...
  return (
    <>
      ...
      <div className={`bg-gray-200 min-h-screen mt-6 ${loading ? 'hidden' : ''}`} style={{ textAlign: "center", display: "flex", flexDirection: "column" }}>
        <div className="flex px-2 items-center justify-between lg:hidden">
          ...
          <div className="lg:block hidden gap-2 items-center ">
            <input
              type="number"
